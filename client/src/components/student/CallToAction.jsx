  ...
  return (
    <div className='flex flex-col items-center gap-4 pt-10 pb-24 px-8 md:px-0'>
        ...
        <p className='text-gray-500 sm:text-sm'>
          Learn anytime, anything, anywhere with our courses, designed for flexible and accessible learning. Gain knowledge at your own pace with expert-led content, anytime you need it!
        </p>
